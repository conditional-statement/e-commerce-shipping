	...
	<form action="" method="post" id="frm_basket">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat br_bd">
			...
			<tr class="rowHighlight">
				...
				<td class="ta_r br_td">
					<i>&pound;<?php echo number_format($objBasket->_sub_total, 2); ?></i>
				</td>
			</tr>
			...
			<?php foreach($shipping as $srow) { ?>
				...
				<tr>
					...
					<td class="ta_r">
						&pound;<?php echo number_format($srow['cost'], 2); ?>
					</td>
				</tr>
		...
		<tbody class="rowHighlight">
			...
			<tr>
				...
				<td class="ta_r br_td" id="basketSubTotal">
					&pound;<?php echo number_format($objBasket->_final_sub_total, 2); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="ta_r br_td" id="basketVat">
					&pound;<?php echo number_format($objBasket->_final_vat, 2); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="ta_r br_td">
					<strong id="basketTotal">&pound;<?php echo number_format($objBasket->_final_total, 2); ?></strong>
				</td>
			</tr>
